	...
	function onRequest(context) {
		try{
			...
			if(request.method === 'GET'){
				...
				/*fileId.folder=13599;
				var fileSave=fileId.save();
				log.debug('fielSave:',fielSave);*/
				...
				context.response.write('<body style="color:red;text-align: center;">Email has been sent Sucessfully.<script>setTimeout("window.close()",5000)</script></body>');
